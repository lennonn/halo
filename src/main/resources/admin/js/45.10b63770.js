"use strict";
(self["webpackChunkhalo_admin"] = self["webpackChunkhalo_admin"] || []).push([[45], {
    3045: function (e, t, a) {
        a.d(t, {
            Z: function () {
                return S
        ...
        var r = function () {
                    ...
                    return a("a-modal", {
                    ...
                    }, [a("a-form-item", {attrs: {label: "页面标题"}}, [a("a-input", {
                        model: {
                    ...
                    }))], 2)], 1), a("a-form-item", {attrs: {label: "封面图："}}, [a("a-space", {attrs: {direction: "vertical"}}, [a("img", {
                        staticClass: "w-1/2 cursor-pointer",
                        staticStyle: {"border-radius": "4px"},
                        attrs: {src: e.form.model.thumbnail || "/images/placeholder.jpg", alt: "Sheet cover thumbnail"},
                        on: {
                            click: function (t) {
                        ...
                        attrs: {metas: e.form.model.metas, targetId: e.form.model.id, target: "sheet"},
                        on: {
                ...
                s = (a(70315), a(41479), a(87591), a(30535), a(85018), a(31875), a(18482), a(86381), a(99421)),
                i = a(91411), m = a(38487), c = a(73511), u = a.n(c), d = a(98906), f = a(94671), h = a(17132), p = {
                    name: "SheetSettingModal",
                    mixins: [i.jB, i.KT],
                    components: {MetaEditor: s.Z},
                    props: {
                    ...
                    computed: (0, l.Z)((0, l.Z)({}, (0, d.Se)(["options"])), {}, {
                        modalVisible: {
                            get: function () {
                                return this.visible
                            }, set: function (e) {
                            ...
                            var e = this.options, t = e.sheet_permalink_type, a = e.blog_url, r = e.sheet_prefix,
                                    o = e.path_suffix, n = void 0 === o ? "" : o, l = this.form.model.slug,
                                    s = void 0 === l ? "{slug}" : l;
                            switch (t) {
                                case"SECONDARY":
                                    return "".concat(a, "/").concat(r, "/").concat(s).concat(n);
                                case"ROOT":
                                    return "".concat(a, "/").concat(s).concat(n);
                                default:
                                    return ""
                            }
                        }, hasId: function () {
                    ...
                    methods: {
                        handleCreateOrUpdate: function () {
                            ...
                            if (this.form.model.title && u().isSupported()) {
                                var e, t = "", a = u().parse(this.form.model.title.replace(/\s+/g, "").toLowerCase());
                ...
                }, b = p, v = a(42177), g = (0, v.Z)(b, r, o, !1, null, null, null), S = g.exports
    }
}]);